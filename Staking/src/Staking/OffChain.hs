    ...
    then logInfo @String
        ...
        let newStakingDat = PoolDatum $ Business.unregister activeUsers ownPKH
            ...
            tx            =
                ...
                <> Constraints.mustPayToPubKey (PaymentPubKeyHash ownPKH) newUserVal
            ...
            let refFees = Business.refillFees feesD
                ...
                tx =  Constraints.mustSpendScriptOutput orefUser red
                   ...
                   <> Constraints.mustPayToPubKey
                        (PaymentPubKeyHash $ refWallet settings) (mainTokenValue refFees <> minAda)
                   <> Constraints.mustPayToPubKey
                        (PaymentPubKeyHash $ daoWallet settings) (mainTokenValue dFees <> minAda)
                   <> Constraints.mustPayToPubKey
                        (PaymentPubKeyHash $ affWallet settings) (mainTokenValue aFees <> minAda)
            ...
            let refFees = Business.refillFees feesW
                ...
                tx =  Constraints.mustSpendScriptOutput orefUser red
                   ...
                   <> Constraints.mustPayToPubKey
                       (PaymentPubKeyHash $ affWallet settings) (mainTokenValue aFees <> minAda)
                   <> Constraints.mustPayToPubKey
                        (PaymentPubKeyHash ownPKH) (mainTokenValue (getMicroToken am) <> minAda)
        ...
        Just (newUserState, rews) -> do
            ...
            let oldStakingVal = getChainIndexTxOutValue oStaking
                ...
                tx =  Constraints.mustSpendScriptOutput orefStaking red
                   ...
                   <> Constraints.mustValidateIn range
                   <> Constraints.mustPayToPubKey
                        (PaymentPubKeyHash ownPKH) (mainTokenValue rews <> minAda)
