...
import           Ledger
import           Ledger.CardanoWallet  as Wallet 
...
wallet :: Int -> MockWallet
wallet i = knownMockWallets !! i

adminWallet :: MockWallet
adminWallet = wallet 0

user1Wallet :: MockWallet
user1Wallet = wallet 1

user1WalletPKH :: PaymentPubKeyHash
user1WalletPKH = Wallet.paymentPubKeyHash user1Wallet
...
walletPKH :: MockWallet -> PaymentPubKeyHash
walletPKH = Wallet.paymentPubKeyHash

testRefWallet, testDaoWallet, testAffWallet :: MockWallet
...
testStakingSettings = StakingSettings
    { refWallet   = unPaymentPubKeyHash $ walletPKH testRefWallet
    , daoWallet   = unPaymentPubKeyHash $ walletPKH testDaoWallet
    , affWallet   = unPaymentPubKeyHash $ walletPKH testAffWallet
